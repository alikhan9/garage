...
const Footer = () => {
    ...
    return (
        <div className='bg-[hsl(200,5%,12%)] p-6'>
            <div className='max-w-[1280px] mx-auto' data-aos="fade-in" data-aos-easing="ease-in-out" data-aos-delay="200" data-aos-once="true">
                <div className="flex flex-col lg:flex-row items-center justify-between mx-auto max-w-screen-2xl">
                    <div className="flex items-center">
                        <a className="ml-4 text-orange-500 text-3xl" href="/">
                            ASM AUTO
                        </a>
                    </div>
                    <ul className="flex flex-col lg:flex-row items-center text-xl font-light text-slate-400 py-12 lg:py-0">
                        <li className="mx-7 hover:text-slate-100 duration-300 mb-2 lg:mb-0">
                    ...
                    <div className="flex text-blue-400">
                        <a className="hover:text-blue-200" href="/">
                            <svg className="mx-4 fill-current" width="21" height="17" viewBox="0 0 21 17" fill="none"
